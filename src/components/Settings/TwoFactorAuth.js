...
const TwoFactorAuth = () => {
    ...
    return (
        <div className="space-y-6">
            <div className="bg-gradient-to-br from-indigo-50 to-white border border-indigo-100/50 rounded-[2rem] p-6 lg:p-8">
                <div className="max-w-2xl">
                    ...
                    <div className="p-4 bg-white/60 backdrop-blur-md rounded-2xl border border-white shadow-sm mb-8">
                        <p className="text-sm text-gray-500 font-bold leading-relaxed">
                            <Lock size={14} className="inline mr-2 text-indigo-400" />
                    ...
                    <div className="space-y-3">
                        {methods.map((method) => (
                            <button
                                key={method.id}
                                className="w-full group flex items-center justify-between p-4 bg-white hover:bg-gray-50 border border-gray-100 rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-0.5"
                            >
                                <div className="flex items-center gap-4 text-left">
                                    <div className={`p-3 rounded-xl ${method.bgColor} ${method.color} transition-colors group-hover:scale-110 duration-500`}>
                                ...
                                <div className="p-2 rounded-xl bg-gray-50 group-hover:bg-indigo-50 text-gray-300 group-hover:text-indigo-600 transition-all">
                        ...
                        {!expanded ? (
                            <button
                                ...
                                className="w-full py-4 text-sm font-black text-gray-400 uppercase tracking-[0.2em] hover:text-indigo-600 transition-colors flex items-center justify-center gap-2"
                            >
                                <MoreHorizontal size={16} />
                                Mostrar opciones adicionales
                            </button>
                        ) : (
                            <div className="pt-4 space-y-3 animate-in fade-in slide-in-from-top-2 duration-500">
                                <button className="w-full group flex items-center justify-between p-4 bg-zinc-50 hover:bg-zinc-100 border border-zinc-200 border-dashed rounded-2xl transition-all">
                                    <div className="flex items-center gap-4 text-left">
                                        <div className="p-3 rounded-xl bg-zinc-200 text-zinc-600">
                                            <Monitor size={22} strokeWidth={2.5} />
                                        </div>
                                        <div>
                                            <h4 className="font-bold text-gray-900">Códigos de respaldo</h4>
                                            <p className="text-xs text-gray-500 font-medium mt-0.5">
                    ...
                    <div className="mt-8 pt-8 border-t border-indigo-100/50">
                        <div className="flex items-start gap-4">
                            ...
                            <p className="text-xs text-gray-500 font-bold leading-relaxed">
                                <span className="text-amber-600 uppercase tracking-tighter mr-2">Recomendación:</span>
